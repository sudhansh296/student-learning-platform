...
var QUESTIONS = [
  ...
  { id:12, cat:'css', diff:'easy', q:'Which property controls the spacing inside an element border?', opts:['margin','spacing','padding','border-spacing'], ans:2, exp:'padding controls the space between content and the element border. margin controls space outside the border.' },
